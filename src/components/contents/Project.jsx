...
const projects = [
  ...
  },
  {
    ...
    description:  "Tech stack : React(Frontend), Bootstrap(UI Framework), NodeJs and Express(Backend), Mongodb(Database)"
  },
  {
    id: 3,
  ...
  },
  {
    ...
    description:
    "Tech stack : React(Frontend), Bootstrap(UI Framework), Firebase(Database)"
  },
];
      ...
      <div className="row">
        {projects.map(project => (
          <div key={project.id} className="col-md-4 mb-4">
            <div className="card">
              <img src={profile_1} className="card-img-top" alt="..." />
